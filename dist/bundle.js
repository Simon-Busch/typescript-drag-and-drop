...
define("components/project-input", ["require", "exports", "components/base-component", "util/validation", "decorators/autobind", "state/project-state-management"], function (require, exports, base_component_js_1, validation_js_1, autobind_js_1, project_state_management_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectInput extends base_component_js_1.Component {
        ...
        submitHandler(event) {
            ...
            if (Array.isArray(userInput)) {
                ...
                project_state_management_js_1.projectState.addProject(title, desc, people);
                this.clearInputs();
            }
        }
    }
...
define("components/project-list", ["require", "exports", "components/base-component", "models/project", "decorators/autobind", "components/project-item", "state/project-state-management"], function (require, exports, base_component_js_3, project_js_2, autobind_js_3, project_item_js_1, project_state_management_js_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_js_3.Component {
        ...
        dropHandler(event) {
            ...
            project_state_management_js_2.projectState.moveProject(prjId, this.type === 'active' ? project_js_2.ProjectStatus.Active : project_js_2.ProjectStatus.Finished);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector('ul');
        ...
        configure() {
            ...
            project_state_management_js_2.projectState.addListener((projects) => {
